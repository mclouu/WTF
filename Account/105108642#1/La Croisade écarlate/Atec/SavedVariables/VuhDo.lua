...
VUHDO_PANEL_SETUP = {
	...
	["HOTS"] = {
		...
		["SLOTS"] = {
			"Brume de rénovation", -- [1]
			"Brume enveloppante", -- [2]
			"Brume apaisante", -- [3]
			"Réceptacle d’essence", -- [4]
			"Cocon de vie", -- [5]
			"Breuvage poussière-d’os", -- [6]
			"", -- [7]
			"", -- [8]
			"", -- [9]
...
VUHDO_RAID = {
	["player"] = {
		...
		["powertype"] = 3,
		["healthmax"] = 23480,
		["lifeLossPerc"] = 1.033450704225352,
		["dead"] = false,
		["charmed"] = false,
		["fullName"] = "Atec",
		["power"] = 100,
