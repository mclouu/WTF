...
VUHDO_BUFF_ORDER = {
	["Suppression de la douleur"] = 2,
	["Mot de pouvoir : Robustesse"] = 6,
	["Infusion de puissance"] = 1,
	["Ombrefiel"] = 4,
	["Lévitation"] = 5,
	["Étreinte vampirique"] = 3,
}
VUHDO_SPEC_LAYOUTS = {
	["1"] = "",
	["3"] = "",
